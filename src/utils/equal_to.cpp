...
namespace loki
{
bool EqualTo<const ActionImpl*>::operator()(const ActionImpl* l, const ActionImpl* r) const
{
    if (&l != &r)
    {
...
bool EqualTo<const AtomImpl*>::operator()(const AtomImpl* l, const AtomImpl* r) const
{
    if (&l != &r)
    {
...
bool EqualTo<const AxiomImpl*>::operator()(const AxiomImpl* l, const AxiomImpl* r) const
{
    if (&l != &r)
    {
...
bool EqualTo<const ConditionLiteralImpl&>::operator()(const ConditionLiteralImpl& l, const ConditionLiteralImpl& r) const
{
    if (&l != &r)
    {
...
bool EqualTo<const ConditionAndImpl&>::operator()(const ConditionAndImpl& l, const ConditionAndImpl& r) const
{
    if (&l != &r)
    {
...
bool EqualTo<const ConditionOrImpl&>::operator()(const ConditionOrImpl& l, const ConditionOrImpl& r) const
{
    if (&l != &r)
    {
        return (get_sorted_vector(l.get_conditions()) == get_sorted_vector(r.get_conditions()));
...
bool EqualTo<const ConditionNotImpl&>::operator()(const ConditionNotImpl& l, const ConditionNotImpl& r) const
{
    if (&l != &r)
    {
...
bool EqualTo<const ConditionImplyImpl&>::operator()(const ConditionImplyImpl& l, const ConditionImplyImpl& r) const
{
    if (&l != &r)
    {
...
bool EqualTo<const ConditionExistsImpl&>::operator()(const ConditionExistsImpl& l, const ConditionExistsImpl& r) const
{
    if (&l != &r)
    {
...
bool EqualTo<const ConditionForallImpl&>::operator()(const ConditionForallImpl& l, const ConditionForallImpl& r) const
{
    if (&l != &r)
    {
        return (l.get_condition() == r.get_condition()) && (get_sorted_vector(l.get_parameters()) == get_sorted_vector(r.get_parameters()));
...
bool EqualTo<const ConditionImpl*>::operator()(const ConditionImpl* l, const ConditionImpl* r) const { return EqualTo<ConditionImpl>()(*l, *r); }

bool EqualTo<const DomainImpl*>::operator()(const DomainImpl* l, const DomainImpl* r) const
{
    if (&l != &r)
    {
...
bool EqualTo<const EffectLiteralImpl&>::operator()(const EffectLiteralImpl& l, const EffectLiteralImpl& r) const
{
    if (&l != &r)
    {
        return (l.get_literal() == r.get_literal());
...
bool EqualTo<const EffectAndImpl&>::operator()(const EffectAndImpl& l, const EffectAndImpl& r) const
{
    if (&l != &r)
    {
...
bool EqualTo<const EffectNumericImpl&>::operator()(const EffectNumericImpl& l, const EffectNumericImpl& r) const
{
    if (&l != &r)
    {
...
bool EqualTo<const FunctionExpressionBinaryOperatorImpl&>::operator()(const FunctionExpressionBinaryOperatorImpl& l,
...
bool EqualTo<const FunctionExpressionMultiOperatorImpl&>::operator()(const FunctionExpressionMultiOperatorImpl& l,
...
bool EqualTo<const FunctionExpressionMinusImpl&>::operator()(const FunctionExpressionMinusImpl& l, const FunctionExpressionMinusImpl& r) const
{
    if (&l != &r)
    {
...
bool EqualTo<const FunctionExpressionFunctionImpl&>::operator()(const FunctionExpressionFunctionImpl& l, const FunctionExpressionFunctionImpl& r) const
{
    if (&l != &r)
    {
...
bool EqualTo<const FunctionExpressionImpl*>::operator()(const FunctionExpressionImpl* l, const FunctionExpressionImpl* r) const
{
    return EqualTo<FunctionExpressionImpl>()(*l, *r);
}

template<>
struct EqualTo<const FunctionSkeletonImpl*>
{
    bool operator()(const FunctionSkeletonImpl* l, const FunctionSkeletonImpl* r) const;
};

bool EqualTo<const FunctionSkeletonImpl*>::operator()(const FunctionSkeletonImpl* l, const FunctionSkeletonImpl* r) const
{
    if (&l != &r)
    {
...
bool EqualTo<const FunctionImpl*>::operator()(const FunctionImpl* l, const FunctionImpl* r) const
{
    if (&l != &r)
    {
...
bool EqualTo<const LiteralImpl*>::operator()(const LiteralImpl* l, const LiteralImpl* r) const
{
    if (&l != &r)
    {
...
bool EqualTo<const OptimizationMetricImpl*>::operator()(const OptimizationMetricImpl* l, const OptimizationMetricImpl* r) const
{
    if (&l != &r)
    {
...
bool EqualTo<const NumericFluentImpl*>::operator()(const NumericFluentImpl* l, const NumericFluentImpl* r) const
{
    if (&l != &r)
    {
...
bool EqualTo<const ObjectImpl*>::operator()(const ObjectImpl* l, const ObjectImpl* r) const
{
    if (&l != &r)
    {
...
bool EqualTo<const ParameterImpl*>::operator()(const ParameterImpl* l, const ParameterImpl* r) const
{
    if (&l != &r)
    {
...
bool EqualTo<const PredicateImpl*>::operator()(const PredicateImpl* l, const PredicateImpl* r) const
{
    if (&l != &r)
    {
        return (l->get_name() == r->get_name()) && (get_sorted_vector(l->get_parameters()) == get_sorted_vector(r->get_parameters()));
...
bool EqualTo<const ProblemImpl*>::operator()(const ProblemImpl* l, const ProblemImpl* r) const
{
    if (&l != &r)
    {
...
bool EqualTo<const RequirementsImpl*>::operator()(const RequirementsImpl* l, const RequirementsImpl* r) const
{
    if (&l != &r)
    {
...
bool EqualTo<const TermObjectImpl&>::operator()(const TermObjectImpl& l, const TermObjectImpl& r) const
{
    if (&l != &r)
    {
...
bool EqualTo<const TermVariableImpl&>::operator()(const TermVariableImpl& l, const TermVariableImpl& r) const
{
    if (&l != &r)
    {
...
bool EqualTo<const TermImpl*>::operator()(const TermImpl* l, const TermImpl* r) const { return EqualTo<TermImpl>()(*l, *r); }

bool EqualTo<const TypeImpl*>::operator()(const TypeImpl* l, const TypeImpl* r) const
{
    if (&l != &r)
    {
        return (l->get_name() == r->get_name()) && (get_sorted_vector(l->get_bases()) == get_sorted_vector(r->get_bases()));
...
bool EqualTo<const VariableImpl*>::operator()(const VariableImpl* l, const VariableImpl* r) const
{
    if (&l != &r)
    {
