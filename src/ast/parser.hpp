...
typedef x3::rule<EffectCompositeForallClass, ast::EffectCompositeForall> effect_conditional_forall_type;
typedef x3::rule<EffectCompositeWhenClass, ast::EffectCompositeWhen> effect_conditional_when_type;
...
parser::effect_composite_type const& effect_conditional();
